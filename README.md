...
## About
This package contains various coder-friendly and high-level wrappers for the most used low-level SLProtocol methods, please find these documented [here](https://aka.dataminer.services/ProtocolExtensionClass).
